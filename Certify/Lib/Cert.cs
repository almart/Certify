...
namespace Certify
{
    class Cert
    {
        ...
        private static CertificateRequest CreateCertRequestMessage(string templateName, bool machineContext = false, string subjectName = "", string altName = "", string url = "", string sidExtension = "")
        {
            ...
            IX509CertificateRequestPkcs10V3 objPkcs10 = 
(IX509CertificateRequestPkcs10V3)Activator.CreateInstance(Type.GetTypeFromProgID("X509Enrollment.CX509CertificateRequestPkcs10"));
